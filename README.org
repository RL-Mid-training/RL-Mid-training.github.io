...
@@html:<div class="row"><h2 class="col-md-12 text-center"><strong><font size="+2r" color="red">Work In Progress, DO NOT DISTRIBUTE</font></strong></h2></div>@@
...
#+html: <img src="figures/performance_0_500_run.jpg" style="width:100%;image-rendering:auto;">

*Parameter Scaling:* We trained models ranging from 1.7B to 8B parameters. Our method shows consistent improvements across all model sizes on a wide range of benchmarks including MMLU, OpenCompass, GSM8K, GPQA, Hendrycks/APPS, LiveCodeBench, and MATH.

*Data Scaling:* We demonstrate that model performance increases as we expose models to more data over the course of RLM training. Our largest run scaled up to 128,000 documents and utilized over 4,000 GPU-hours on Isambard.

#+html: <img src="figures/train_reward.png" style="width:100%;image-rendering:auto;">

*Scaling Laws:* The in-task performance on the RLM objective scales linearly with log-compute, reminiscent of pre-training cross-entropy scaling laws. This is a crucial finding, as pre-training scaling characteristics have been the biggest driver of recent LLM development.

** Post-Training Benefits

#+html: <img src="figures/math_post_training.jpg" style="width:100%;image-rendering:auto;">

RLM provides benefits even when followed by post-training. We show that:
- Models with RLM + post-training outperform post-training alone across all model sizes
- RLM increases the saturation point of post-training, making it beneficial even with unlimited post-training compute
- This suggests the scarcity of post-training data is a fundamental bottleneck that RLM helps address
...
@misc{rlm2025,
      title={Reinforcement Learning Mid-Training for LLMs},
      author={Eltayeb Ahmed and Anya Sims and Thomas Foster and Jakob Foerster},
      year={2025}
}</textarea>
</div></div>
#+end_export
